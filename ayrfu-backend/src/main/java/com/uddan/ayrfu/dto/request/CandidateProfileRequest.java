...
public class CandidateProfileRequest {
    ...
    public CandidateProfileRequest(String fullName, String email, String phoneNumber, String address,
    ...
    public boolean equals(Object o) {
        ...
        CandidateProfileRequest that = (CandidateProfileRequest) o;
    ...
    public static class Builder {
        ...
        public CandidateProfileRequest build() {
            return new CandidateProfileRequest(fullName, email, phoneNumber, address, dateOfBirth, gender,
                    technologies, languages, experienceLevel, preferredLocation, preferredWorkModel);
        }
    }
}
  ...
  useEffect(() => {
    ...
    const fetchMessages = async () => {
      ...
      try {
        ...
        const response = await axios.get('/api/messages/type/CLIENT', {
  ...
  const handleSendReply = async () => {
    ...
    try {
      ...
      await axios.post('/api/messages/reply', {
        ...
        subject: `Re: Client Message from ${selectedMessage.senderName}`,
        content: replyText
      }, {
        headers: { Authorization: `Bearer ${token}` }
      });
                  ...
                  <ListItemText
                    primary={
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        {!message.read && (
                          <Chip size="small" label="New" color="secondary" sx={{ ml: 1 }} />
                        )}
                      </Box>
                    }
                    secondary={
...
export default AdminClientMessagesPage;
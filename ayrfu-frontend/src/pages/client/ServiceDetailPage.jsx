...
const ServiceDetailPage = () => {
    ...
    return (
      <Container maxWidth="md" sx={{ py: 8 }}>
        <Paper sx={{ p: 4, textAlign: 'center' }}>
          <Typography variant="h5" color="error" gutterBottom>Error loading service</Typography>
  ...
  if (!currentService) {
    return (
      <Container maxWidth="md" sx={{ py: 8 }}>
        <Paper sx={{ p: 4, textAlign: 'center' }}>
          <Typography variant="h5" gutterBottom>Service not found</Typography>
  ...
  const benefitsList = currentService.benefits ? 
    currentService.benefits.split(',').map(benefit => benefit.trim()) : [];
    ...
    <Container maxWidth="lg" sx={{ py: 8 }}>
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} md={8}>
          <Paper sx={{ p: 4, mb: 4 }}>
            <Typography variant="h4" gutterBottom>{currentService.title}</Typography>
            ...
            <Typography variant="h6" gutterBottom sx={{ mt: 4 }}>Key Benefits</Typography>
            <List>
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ mb: 4 }}>
            <CardContent>
              ...
              <Button 
                ...
                onClick={() => navigate('/client/services/request', { state: { serviceId: currentService.id } })}
                sx={{ mt: 2 }}
              >
          ...
          <Paper sx={{ p: 3 }}>
            <Typography variant="h6" gutterBottom>Related Services</Typography>
            <Divider sx={{ mb: 2 }} />
            <List disablePadding>
